                    ...
                    <form role="form" enctype="multipart/form-data">
                        <div class="col-sm-12" style="text-align : left;">
                            ...
                            <div class="form-group col-sm-6"> 
                                ...
                                <input type="text" class="form-control" id="txt_uname" style="width:95%;" value="Username" required>
                            </div>
                            <div class="form-group col-sm-6">
                                <label>Email</label>
                                <input type="email" class="form-control" id="txt_pass" style="width:95%;" value="Email Id" required>
                            </div>

                            <div class="form-group col-sm-6"> 
                                <label>FirstName</label>
                                <input type="text" class="form-control" id="txt_fname" style="width:95%;" value="Firstname" required>
                            </div>
                            <div class="form-group col-sm-6">
                                <label>LastName</label>
                                <input type="text" class="form-control" id="txt_lname" style="width:95%;" value="Lastname" required>
                            </div>
