			...
			<!-- edited by vdm -->
				...
				<table id="example" class="display" cellspacing="0" width="100%">
					...
					<?php
						...
						$result = $ob->display_log();
						
						while($arr = mysqli_fetch_array($result)){
					?>		
						 <tr>
							 <td><?php echo $arr['in_log_id']; ?></td>
							 <td><?php echo $arr['in_id']; ?></td>
							 <td><?php echo $arr['st_username']; ?></td>
							 <td><?php echo $arr['ip_address_remote']; ?></td>
							 <td><?php echo $arr['dt_log']; ?></td>
							 <td><?php echo $arr['tm_log_in']; ?></td>
							 <td><?php echo $arr['tm_log_out']; ?></td>
							 <td><?php echo ($arr['tm_log_out'] == '00:00:00') ? 'online' : 'offline'; ?></td>
							...
							<form method="post">
							  ...
							  <div class="modal-footer">
								<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
								  <button id="report_btn_d" class="btn btn-primary">Disable</button>
							  </div>	
							</form>	
				...
				<div id="Report_Modal_e" class="modal fade" role="dialog">
					<div class="modal-dialog">
							...
							<form method="post">
							  ...
							  <div class="modal-footer">
								<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
								  <button id="report_btn_e" class="btn btn-primary">Enable</button>
							  </div>	
							</form>	
