...
<html>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
		 ...
		 <div style="float:right">
			<a target="_blank" href="http://localhost/forum/AdminLTE-2.3.0/add-user.php"><button class="btn btn-success"><span class="glyphicon glyphicon-plus"></span></button></a>
		</div>
			...
			<!-- data table -->
				...
				<?php
					...
					?>		
						 <tr>
							 <td><?php echo $arr['in_id']; ?></td>
							 <td><?php echo $arr['st_email_id']; ?></td>
							 <td><?php echo $arr['st_username']; ?></td>
							 <td><?php echo $arr['st_first_name']; ?></td>
							 <td><?php echo $arr['st_last_name']; ?></td>
							 <td><?php echo $arr['st_gender']; ?></td>
							 <td><?php echo $arr['dt_birthdate']; ?></td>
							 <td><img src="../images/<?php echo $arr['im_profile_picture']; ?>" style="width:80px;height:50px;" /></td>
							 <td><?php echo $arr['st_category_name']; ?></td>
							 <td><?php echo $arr['dt_join']; ?></td>
							 <td><?php echo $arr['st_type']; ?></td>
							 <td>
							 <a target="_blank" href="http://localhost/forum/AdminLTE-2.3.0/admin-update-user.php?usr_id=<?php echo $arr['in_id']; ?>"><button data-toggle="modal" data-target="#Edit_question" id="edit-btn<?php echo $arr['in_id']; ?>" data-id='<?php echo $arr['in_id']; ?>'  class = "btn btn-primary edit-btn"><span class="glyphicon glyphicon-edit"></span></button></a>
							 &nbsp;
							 <button id="del-btn<?php echo $arr['in_id']; ?>"  data-id='<?php echo $arr['in_id']; ?>' data-toggle="modal" data-target="#Usr_Modal" class = "btn btn-danger del-usr"><span class="glyphicon glyphicon-remove"></span></button>
							 </td>
			...
			<!-- ------------------------------------------ -->
				...
				<!-- Report enable modal -->
				<div id="Usr_Modal" class="modal fade" role="dialog">
					<div class="modal-dialog">
							...
							<form method="post">
								...
								<div class="form-group">
								  <label for="comment"><h4>Are you sure you want to Delete this User..</h4></label>
								  
								</div>
							  </div>
							  <div class="modal-footer">
								<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
								  <button type="button" id="del_btn_dialog" class="btn btn-danger">Delete</button>
							  </div>	
							</form>	
   ...
   <script src="../js/jquery-1.12.2.min.js"></script>
	...
	$(".del-usr").click(function(){
			usr_id = $(this).data('id');
			
			//console.log("-----"+que_id);
	});

	$("#del_btn_dialog").click(function(){
		$.ajax({
				url:"../php/php-del-user.php",
				method:"POST",
				data:{usr_id:usr_id},
