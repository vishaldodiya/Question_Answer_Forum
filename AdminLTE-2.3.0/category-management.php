...
<html>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
		...
		<div style="float:right">
			<button class="btn btn-success" data-toggle="modal" data-target="#Add-cat" ><span class="glyphicon glyphicon-plus"></span></button>
		</div>
			...
			<!-- data table -->
				...
				<?php
					...
					?>		
						 <tr>
							 <td><?php echo $arr['in_category_id']; ?></td>
							 <td><?php echo $arr['st_category_name']; ?></td>
							 <td><?php echo $arr['in_category_count']; ?></td>
							 <td><button data-toggle="modal" data-target="#Edit_category" id="edit-btn<?php echo $arr['in_category_id']; ?>" data-name="<?php echo $arr['st_category_name']; ?>" data-id='<?php echo $arr['in_category_id'];  ?>' class = "btn btn-primary edit-btn"><span class="glyphicon glyphicon-edit"></span></button>&nbsp;<button id="del-btn<?php echo $arr['in_category_id']; ?>" data-id='<?php echo $arr['in_category_id'];  ?>' class = "btn btn-danger del-cat"><span class="glyphicon glyphicon-remove"></span></button></td>
					...
					<div class="modal-dialog">
							...
							<form method="post">
								...
								<div class="form-group">
								  <label for="comment"><h4>Update Category</h4></label>
								  <input type="text" id="in_category_txt" value="" />
								  
								</div>
							  </div>
							  <div class="modal-footer">
								<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
								  <button type="button" id="cat_btn_edit" class="btn btn-primary">Edit</button>
							  </div>	
							</form>	
					...
					<div class="modal-dialog">
							...
							<form method="post">
								...
								<div class="form-group">
								  ...
								  <input type="text" class="form-control" id="in_category_name" placeholder="Enter category name">
								  
								</div>
							  </div>
							  <div class="modal-footer">
								<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
								  <button type="button" id="cat_btn_add" class="btn btn-primary">Add</button>
							  </div>	
							</form>	
    ...
    $(".edit-btn").click(function(){
			...
			$("#in_category_txt").val(cat_name);
			
			
		});
	
	$("#cat_btn_edit").click(function(){
		var new_cat = $("#in_category_txt").val();
		$.ajax({
			url:"../php/php-edit-category.php",
			method:"POST",
			data:{cat_id:cat_id,new_cat:new_cat},
	...
	$("#cat_btn_add").click(function(){
		var cat_name = $("#in_category_name").val();
		$.ajax({
			url:"../php/php-add-category.php",
			method:"POST",
